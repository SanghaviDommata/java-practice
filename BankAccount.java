...
public class BankAccount {
	...
	public void diposit(double amount) {
		if(amount>0) {
			balance+=amount;
			System.out.println("Cash diposited: "+amount);
		}else {
			System.out.println("Diposit amount must be positive");
		}
	}
	public void deposit(String checkNum,double amount) {
		if(amount>0) {
			balance+=amount;
			System.out.println("Check diposited : checknum: "+checkNum+" Amount: "+amount);
		}else {
			System.out.println("Diposit amount must positive");
		}
	}
